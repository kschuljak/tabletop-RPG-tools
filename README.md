...
// A random number between 0 & 2 is then generated, and an option is randomly selected from the secondSyllable array and added to the outputName that many times
